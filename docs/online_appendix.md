# Online Appendix: Mathematical Derivations
...
*[Figure 1 placeholder: Parameter space diagram showing first-best enclosure regions]*
...
*[Figure 2 placeholder: Parameter space diagram showing decentralized enclosure regions including multiplicity region]*
...
*[Figure 3 placeholder: Comparison of first-best, second-best, and private enclosure thresholds]*
...
*[Figure 4 placeholder: Diagram illustrating MPL, APL and labor misallocation showing DWL]*
...
*[Figure 5 placeholder: Labor allocation curves $l_e^\mu(t_e)$ for different values of $\mu$]*
...
*[Figure 6 placeholder: Four-panel diagram showing effects of varying $\mu$ and $\tau$ on equilibrium outcomes]*
...
*[Figure 7 placeholder: Monopolist's enclosure decisions vs. competitive outcomes]*
...
**Code Repository:** https://github.com/open-enclose/enclose_book/ (placeholder)
